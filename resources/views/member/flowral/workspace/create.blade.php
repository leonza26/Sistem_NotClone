    ...
    <div class="px-10 pb-12">
        <header class="max-w-3xl mb-8">
            ...
            <h2 class="font-headline text-display-md text-4xl font-extrabold text-on-surface leading-tight tracking-tight">
                Create <span class="text-primary">Workspace.</span>
            </h2>
        </header>
                ...
                <form action="{{ route('member.workspace.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            required placeholder="e.g. Marketing Team, Project Alpha...">
                        @error('name')
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-outline-variant mt-8">
                        ...
                        <button type="submit"
                            class="px-5 py-2.5 text-sm font-bold text-on-primary bg-primary rounded-xl shadow-md hover:shadow-lg transition">Save
                            Workspace</button>
                    </div>
                </form>
            </div>
