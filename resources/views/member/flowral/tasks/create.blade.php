...
@section('content')
    <div class="px-8 lg:px-10 pb-12 pt-4 max-w-4xl">
        <header class="mb-10">
            ...
            <p class="text-brand-slate dark:text-slate-300 font-light mt-1 text-sm">Tambahkan pekerjaan baru dan assign ke anggota tim Anda.</p>
        </header>
        ...
        <div
            ...
            <form action="{{ route('member.tasks.store') }}" method="POST" x-data="{
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <!-- Status -->
                    <div class="space-y-1.5">
                        <label for="status" class="block text-xs font-semibold tracking-wide text-brand-slate dark:text-slate-300 ml-1">Status
                            Awal</label>
                ...
                <div class="space-y-1.5 mb-6">
                    <div class="flex items-center justify-between mb-1.5 px-1">
                        <label for="description"
                            class="block text-xs font-semibold tracking-wide text-brand-slate dark:text-slate-300">Description
                            (Opsional)</label>
                        ...
                        <button type="button" @click="generateDescription()" :disabled="isGenerating || !taskTitle"
                            ...
                            :class="isGenerating || !taskTitle ? 'text-brand-slate/50 cursor-not-allowed' : 'text-brand-orange hover:bg-brand-orange/10'">
