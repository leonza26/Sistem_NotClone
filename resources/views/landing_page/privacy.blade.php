...
@section('content')
    ...
    <main class="pt-40 pb-20 max-w-3xl mx-auto px-6">
        <div class="mb-12">
            <h1 class="font-outfit text-4xl md:text-5xl font-medium text-brand-dark dark:text-white mb-4">Privacy Policy</h1>
            <p class="text-brand-slate dark:text-slate-300 font-light">Last updated: June 2026</p>
        </div>

        <div class="space-y-8 text-brand-slate dark:text-slate-300 font-light leading-relaxed">
            <section>
                <h2 class="font-outfit text-2xl font-medium text-brand-dark dark:text-white mb-3">1. Information We Collect</h2>
            ...
            <section>
                <h2 class="font-outfit text-2xl font-medium text-brand-dark dark:text-white mb-3">2. How We Use Your Data</h2>
            ...
            <section>
                <h2 class="font-outfit text-2xl font-medium text-brand-dark dark:text-white mb-3">3. Data Security</h2>
            ...
            <section>
                <h2 class="font-outfit text-2xl font-medium text-brand-dark dark:text-white mb-3">4. Contact Us</h2>
