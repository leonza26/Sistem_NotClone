...
@section('content')
        ...
        <div class="hero-img-wrap gsap-hidden w-full max-w-6xl mx-auto px-6 mt-24 relative z-20 perspective-1000">
            <div
                ...
                <img src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=2000&auto=format&fit=crop"
                    ...
                    class="w-full rounded-xl md:rounded-[24px] shadow-sm dark:shadow-none object-cover aspect-video">
            </div>
        </div>
    </section>
    ...
    <section
        class="py-10 border-y border-brand-teal/10 dark:border-brand-teal/20 bg-white dark:bg-slate-800 overflow-hidden flex flex-col items-center">
        <p class="text-xs font-semibold tracking-widest text-brand-slate dark:text-slate-300 uppercase mb-8 text-center">
            @lang('landing.trusted_by')</p>
        <div
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 mb-40 showcase-row">
                ...
                <div class="w-full lg:w-1/2 showcase-img">
                    <div
                        class="rounded-3xl overflow-hidden border border-brand-teal/20 dark:border-brand-teal/30 shadow-2xl dark:shadow-none">
                        <img src="{{ asset('img/pict_land2.jpg') }}" alt="Kanban Feature" class="w-full h-auto">
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row-reverse items-center gap-16 showcase-row">
                ...
                <div class="w-full lg:w-1/2 showcase-img">
                    <div
                        class="rounded-3xl overflow-hidden border border-brand-teal/20 dark:border-brand-teal/30 shadow-2xl dark:shadow-none relative">
                        <img src="{{ asset('img/pict_land3.jpg') }}" alt="Team Collaboration" class="w-full h-auto">
                    </div>
                </div>
            </div>
                ...
                <div
                    ...
                    <div>
                        <div
                            ...
                            <svg class="w-5 h-5 text-brand-slate dark:text-slate-300" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>
                        </div>
                        <h3 class="font-outfit text-2xl font-medium text-brand-dark dark:text-white mb-3">@lang('landing.bento_1_title')
                        </h3>
                        <p class="text-brand-slate dark:text-slate-300 font-light">@lang('landing.bento_1_desc')</p>
                    </div>
                    <img src="{{ asset('img/pict_land4.jpg') }}"
                        class="w-full h-32 object-cover rounded-xl mt-4 opacity-80 mix-blend-multiply dark:opacity-100 dark:mix-blend-normal"
                        alt="Workspaces">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div
                    ...
                    <ul class="space-y-4 mb-10">
                        <li class="flex items-center gap-3 text-brand-slate dark:text-slate-300 font-light"><svg
