...
<body
    ...
    <div class="hidden lg:flex lg:w-5/12 relative bg-[#1E2120] items-end p-12 overflow-hidden">
        ...
        <div class="relative z-10 max-w-sm mb-10">
            ...
            <h2 class="font-outfit text-4xl font-medium text-white mb-4 leading-tight">@lang('auth_page.start_building_1') <br />@lang('auth_page.start_building_2')
            </h2>
        ...
        <div class="w-full max-w-md mx-auto z-10 py-10">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    <label for="name" class="block text-xs font-semibold tracking-wide text-brand-slate dark:text-slate-300">@lang('auth_page.full_name_label')</label>
                ...
                <!-- Email -->
                <div class="space-y-1.5">
                    <label for="email" class="block text-xs font-semibold tracking-wide text-brand-slate dark:text-slate-300">@lang('auth_page.work_email_label')</label>
                ...
                <div class="flex items-start gap-2 pt-2">
                    ...
                    <label for="terms" class="text-[13px] font-light text-brand-slate dark:text-slate-300 leading-snug">
                        @lang('auth_page.agree_terms') <a href="#"
                            class="font-medium text-brand-dark dark:text-white hover:text-brand-orange transition-colors">@lang('auth_page.terms_link')</a> @lang('auth_page.and') <a href="#"
